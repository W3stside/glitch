//Incoming message here - de-diacritic...ing? and removing "." + "-"
    messageText = message.text !== undefined ? utils.cleanseText(message.text) : new Error ("messageText error");
    var multiStop = {};  
    ...
    if (messageText) {
        ...
        ///////////////////////////////////////////////////////    
          ...
          case 'charles de gaulle':
            ...
            /*//M1
            utils.searchStop(senderID, 'fr-idf', '%3AOIF%3A100110001%3A1OIF439' , '%3AOIF%3ASA%3A8775800', 0, 4, 0);
            //M2
            utils.searchStop(senderID, 'fr-idf', '%3AOIF%3A100110002%3A2OIF439' , '%3AOIF%3ASA%3A8775800', 0, 4, 1);
            //M6
            utils.searchStop(senderID, 'fr-idf', '%3AOIF%3A100110006%3A6OIF439' , '%3AOIF%3ASA%3A8775800', 0, 4, 2);*/
            break;
...
//If incoming message contains coordinates - then it is a callback message from an "arret proche" request
  if (senderCoordinates) {
    //if (sendercoordinates) THEN start Google Maps API search                          
    utils.fullGoogleSearch(senderCoordinates.lat + ',' + senderCoordinates.long, null, senderID);
  }
  //Else if the incoming message DOES NOT have senderCoordinates, meaning it is not an 'arret proche' inquiry, then assume it is a normal request
  else {}